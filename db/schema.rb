...
ActiveRecord::Schema.define(version: 20170526184104) do
  ...
  add_index "comments", ["authour_id"], name: "index_comments_on_authour_id", using: :btree
  ...
  add_index "views", ["goal_id"], name: "index_views_on_goal_id", using: :btree
